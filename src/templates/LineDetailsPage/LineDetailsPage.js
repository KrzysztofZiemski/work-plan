...
export const LineDetailsPage = props => {
    ...
    const handleUpdateLine = (data) => {
        LineService.update(params.idLine, data)
            ...
            .catch(err => setMessage({ isOpen: true, text: ['Wystąpił błąd łączności', `Błąd ${err}`, 'spróbuj ponownie'] }));
    }
        ...
        isExistingId ? (
            < section className={props.className} >
                ...
                <Card container component={Grid}>
                    <HeaderDetails content={content} onChange={handleUpdateLine} onRemove={handleRemoveLine} />
